...
void initialize_rooms() {
	...
	//инициализация инфо о комнатах
	{
		room_info[0].text_info = (char*)"Ферма - производит еду, с увел уровня увеличивается и кол-во производимой еды";
		room_info[1].text_info = (char*)"Фабрика - производит ресурсыб с увел уровня увеличивается и кол-во производимых ресурсов";
		room_info[2].text_info = (char*)"Обащага - с уровнем в убежище сможет поместиться больше людей";
		room_info[3].text_info = (char*)"Оружейная - с уровнем открывается новое оружие";
		room_info[4].text_info = (char*)"Склад - с уровнем увел вместимость убежища";
		room_info[5].text_info = (char*)"Связная - у ее помощью получаем инфо о событиях( 1ур - нападения, 2ур - голосовые опов 3ур - поезда";
	}
}